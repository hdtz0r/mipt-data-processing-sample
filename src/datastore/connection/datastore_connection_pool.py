...
class DatastoreConnectionPool(metaclass=WithLogger):
    ...
    _pool: Queue[DatastoreConnection] = None

    _datastore_name: str = None
    _connection_string: str = None
    _connection_factory: Type[DatastoreConnection] = None
    _max_pool_size: int = None
    _configuration: Configuration = None

    def __init__(self, name: str, connection_string: str, factory: Type[DatastoreConnection], connection_configuration: Configuration, pool_size: int = 1) -> None:
        self._datastore_name = name
        self._configuration = connection_configuration
        self._connection_string = connection_string
        self._connection_ctor = factory
    ...
    def _spawn_new(self) -> DatastoreConnection:
        ...
        connection = self._connection_ctor(
