...
from providers.filesystem.archive_handler import ArchiveHandler
from providers.filesystem.file_handler import FileHandler
from providers.filesystem.generic_handler import GenericHandler
from providers.utils import enumerate_files
...
class FileDataProvider(DataProvider):
    ...
    def _register_handlers_internal(self, package: str, module_consumer: Callable[[GenericHandler], None]):
        ...
        for module_file in filter(lambda file_name: not file_name.startswith("_"), listdir(handler_modules_path)):
            ...
            try:
                module_path = f"providers.filesystem.{package}.{module_name}"
